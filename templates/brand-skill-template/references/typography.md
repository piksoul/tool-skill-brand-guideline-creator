# [CLIENT_NAME] Typography Guidelines
...
2. Set Heading 1: [HEADING_FONT] Bold, 36pt, [PRIMARY_COLOR]
3. Set Body: [BODY_FONT] Regular, 14pt, #1A1A1A
4. Save as template for reuse

### PowerPoint

1. Edit Master Slide
2. Set title: [HEADING_FONT] Bold, 36pt
3. Set body: [BODY_FONT] Regular, 18pt
...
**Customization**: Replace all `[PLACEHOLDERS]` with actual font names and specifications. Add font files to `assets/fonts/` if redistributable.
