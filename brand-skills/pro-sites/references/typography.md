# Pro Sites Typography Guidelines

This document specifies font usage, sizing, and pairing rules for Pro Sites (https://www.pro-sites.com.au) brand materials.

**Font Choice**: Inter is a modern, highly legible typeface optimized for digital interfaces and web applications, making it perfect for a professional web development company.
...
1. Create custom styles for Pro Sites headings
2. Set Heading 1: Inter Bold, 36pt, #0052CC
3. Set Body: Inter Regular, 14pt, #1A1A1A
...
3. Set body: Inter Regular, 18pt
4. Apply to all slide layouts

## Font Licensing

**Important**: Ensure Pro Sites has proper licensing for all fonts used in brand materials.
