# Midsize Standard Typography Guidelines

This document specifies font usage, sizing, and pairing rules for Midsize Standard brand materials.
...
### Subheading Font: Montserrat SemiBold
...
1. Create custom styles for Midsize Standard headings
2. Set Heading 1: Montserrat Bold, 36pt, #0066CC
3. Set Body: Open Sans Regular, 14pt, #1A1A1A
4. Save as template for reuse

### PowerPoint

1. Edit Master Slide
2. Set title: Montserrat Bold, 36pt
3. Set body: Open Sans Regular, 18pt
4. Apply to all slide layouts

## Font Licensing

**Important**: Ensure Midsize Standard has proper licensing for all fonts used in brand materials.
