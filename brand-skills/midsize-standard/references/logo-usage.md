# Midsize Standard Logo Usage Guidelines

This document provides detailed specifications for using Midsize Standard's logo correctly.
...
If you need logo files for Midsize Standard:
1. Check the `assets/` directory in this skill
2. Contact Midsize Standard's marketing/brand team
