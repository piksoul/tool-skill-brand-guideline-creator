# Enterprise Complex Logo Usage Guidelines

This document provides detailed specifications for using Enterprise Complex's logo correctly.
...
If you need logo files for Enterprise Complex:
1. Check the `assets/` directory in this skill
2. Contact Enterprise Complex's marketing/brand team
