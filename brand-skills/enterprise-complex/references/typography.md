# Enterprise Complex Typography Guidelines

This document specifies font usage, sizing, and pairing rules for Enterprise Complex brand materials.
...
### Subheading Font: Source Sans Pro
...
1. Create custom styles for Enterprise Complex headings
2. Set Heading 1: Playfair Display Bold, 36pt, #1E3A8A
3. Set Body: Source Sans Pro Regular, 14pt, #1A1A1A
4. Save as template for reuse

### PowerPoint

1. Edit Master Slide
2. Set title: Playfair Display Bold, 36pt
3. Set body: Source Sans Pro Regular, 18pt
4. Apply to all slide layouts

## Font Licensing

**Important**: Ensure Enterprise Complex has proper licensing for all fonts used in brand materials.
