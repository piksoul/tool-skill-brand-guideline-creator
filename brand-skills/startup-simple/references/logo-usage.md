# Startup Simple Logo Usage Guidelines

This document provides detailed specifications for using Startup Simple's logo correctly.
...
If you need logo files for Startup Simple:
1. Check the `assets/` directory in this skill
2. Contact Startup Simple's marketing/brand team
